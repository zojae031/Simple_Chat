...
public class Login extends DataBaseConnector {
	...
	public static final String checkSQL = "Select * from user where id=? and password =?";
	public static final String updateSQL = "update user set flag=1 where id=? ";
	...
	public Object excute(JsonObject data) throws SQLException {
		...
		if (id.equals(user.id) && user.flag == 0) {// 로그인 o
